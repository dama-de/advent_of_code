...
def solve(inp):
    ...
    for passport in passports:
        ...
        all_present_count = all_present_count + all_present
        try:
            all_valid_count = all_valid_count + (all_present and all(
                required_fields[field[0]](field[1]) for field in fields_with_value))
        except:
            continue
